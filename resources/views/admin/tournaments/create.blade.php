...
@section('page-title', 'Create New Tournament')
                ...
                <div class="card premium-card">
                    <div class="card-header premium-card-header">
                        <h3 class="premium-card-title">
                            <i class="fas fa-trophy"></i> Create New Tournament Details
                        </h3>
                    </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" 
                                        placeholder="e.g. Merlimau Rugby 7s Cup 2026" required autocomplete="off">
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-4">
                                            ...
                                            <input type="number" step="0.01" class="form-control" id="fee" name="fee"
                                                placeholder="e.g. 250.00" value="250.00" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group mb-4">
                                            ...
                                            <input type="number" class="form-control" id="max_teams" name="max_teams"
                                                placeholder="e.g. 16 (Leave blank for unlimited)">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group mb-4">
                                    ...
                                    <input type="text" class="form-control" id="categories" name="categories"
                                        placeholder="e.g. Open 10s, Under-20, Veterans 10s">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="description" name="description" rows="4" 
                                        placeholder="Write tournament rules, schedule descriptions, or pitch logs..."></textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 mt-lg-0 mt-4">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="venue_name" name="venue_name"
                                            placeholder="e.g. Stadium Hang Jebat, Melaka" required autocomplete="off">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control" id="location_coordinates" name="location_coordinates" 
                                        placeholder="Click 'Find Location' or drag marker on map" readonly>
                                </div>
                    ...
                    <div class="card-footer" style="background: rgba(0, 0, 0, 0.15); border-top: 1px solid var(--color-border); padding: 1.25rem 1.5rem;">
                        <button type="submit" class="btn btn-success font-weight-bold shadow-glow-green px-4 py-2">
                            <i class="fas fa-check-circle mr-1"></i> Create Tournament
                        </button>
...
@push('scripts')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            // Initial map state: centered in Malaysia
            const defaultLat = 4.2105;
            const defaultLng = 101.9758;
            
            const map = L.map('map-preview').setView([defaultLat, defaultLng], 5);
