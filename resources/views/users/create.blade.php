...
@section('content')
        <div class="card-header" style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 1rem; padding: 1.25rem 1.5rem; border-bottom: 1px solid var(--color-border);">
            <div style="display: flex; flex-direction: column; gap: 4px;">
                <h2 class="card-title" style="margin: 0; font-size: 1.5rem; font-weight: 700; color: var(--color-text-primary); line-height: 1.2; display: block;">Create New User</h2>
                <p class="card-subtitle" style="margin: 0; font-size: 0.875rem; color: var(--color-text-tertiary); display: block;">Add a new user to the system</p>
            </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <select class="form-control @error('role') is-invalid @enderror" id="role" name="role" required>
                                ...
                                <option value="spectator" {{ old('role') == 'spectator' ? 'selected' : '' }}>Spectator
                                </option>
                            </select>
                            @error('role')
                                <div class="invalid-feedback">{{ $message }}</div>
